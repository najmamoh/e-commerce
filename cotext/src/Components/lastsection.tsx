...
const ContactForm: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Form Section */}
      <div className="relative z-10 bg-white bg-opacity-10 backdrop-blur-md p-6 rounded-lg shadow-lg max-w-4xl w-full">
        <div className="text-center text-white mb-6">
          <h2 className="text-2xl font-bold">CONTACT US</h2>
        </div>
        <div className="text-white space-y-3">
          <p>
            <i className="fas fa-map-marker-alt mr-2"></i> Address, City, Country
          </p>
          <p>
            <i className="fas fa-envelope mr-2"></i> contact@email.com
          </p>
          <p>
            <i className="fas fa-phone mr-2"></i> +00 0000 000 000
          </p>
          <p>
            <i className="fas fa-clock mr-2"></i> Mon - Fri: 8:00 AM to 5:00 PM
          </p>
        </div>
        <form className="mt-6 space-y-4">
          <div className="flex space-x-4">
            <input
              ...
              className="w-1/2 p-3 rounded bg-black bg-opacity-50 text-white placeholder-white focus:ring focus:ring-blue-300"
            />
            <input
              type="email"
          ...
          <textarea
            ...
            className="w-full p-3 h-32 rounded bg-black bg-opacity-50 text-white placeholder-white focus:ring focus:ring-blue-300"
          ></textarea>
        ...
        <div
          className="mt-4 text-green-500 text-sm text-center bg-green-200 rounded p-2"
          hidden
        >
